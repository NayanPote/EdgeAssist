...
import com.nayanpote.edgeassist.R;
import com.nayanpote.edgeassist.databinding.ActivityDeveloperZoneBinding;
...
//            new Handler(Looper.getMainLooper()).postDelayed(this::handleBackPress, 10);
    ...
    private void setupGradientAnimation() {
        if (binding.gradientOverlay != null) {
            binding.gradientOverlay.setBackgroundResource(R.drawable.gradient_background); // your XML file
            Drawable background = binding.gradientOverlay.getBackground();
    ...
    private void shareApp() {
        try {
            ...
            if (originalApk.exists()) {
                ...
                File copiedApk = new File(externalDir, "EdgeAssist_v" + getVersionName() + ".apk");
                ...
                if (copyApkFile(originalApk, copiedApk)) {
                    ...
                    startActivity(Intent.createChooser(shareIntent, "Share EdgeAssist APK"));
                    showCustomToast("Sharing EdgeAssist APK file...");
                } else {
    ...
    private void shareAppAlternative() {
        try {
            ...
            if (originalApk.exists()) {
                ...
                shareIntent.putExtra(Intent.EXTRA_STREAM, apkUri);
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "EdgeAssist App");
                shareIntent.putExtra(Intent.EXTRA_TEXT, "EdgeAssist App\nDeveloped by: Nayan Pote");
    ...
    private void openEmail() {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Regarding EdgeAssist App");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Hello Nayan,\n\nI am writing regarding the EdgeAssist app...\n\nBest regards,");
